<?php
	...
	if( !class_exists('Wbcr_FactoryShortcodes000') ) {
		/**
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryShortcodes000 {
			...
			{
				if( !self::$manager ) {
					self::$manager = new Wbcr_FactoryShortcodes000_ShortcodeManager();
				}
	...
	if( !class_exists('Wbcr_FactoryShortcodes000_ShortcodeManager') ) {
		/**
		 ...
		 */
		class Wbcr_FactoryShortcodes000_ShortcodeManager {

			/**
			 * A set of registered shortcodes.
			 *
			 * @since 1.0.0
			 * @var FactoryShortcodes000_Shortcode[]
			 */
			 ...
			 *
			 * @since 3.2.0
			 * @var Wbcr_FactoryShortcodes000_Shortcode[]
			 */
